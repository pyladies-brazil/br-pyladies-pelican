...
def cria_card(capitulo):
    ...
    img_capitulo = """<div><img class="location-img" src="{}{}" width="100" height="100";></div>""".format(SITEURL, capitulo['image'])
