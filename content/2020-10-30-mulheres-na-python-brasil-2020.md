...
Utilize a descrição pra escolher os temas que mais te interessam e embarque nessa jornada durante a semana.

### Segunda-feira, 02/11/2020
| Trilha | Horário | Tema | Palestrante | Descrição |
|---|---|---|---|---|
| PEP 404 | 15:00 - 15:45 | **Black Friday sem Catástrofes** | **Jéssica Pauli de Castro Bonson** | A Black Friday exige muitos preparos e melhorias na arquitetura do Olist para aguentarmos os milhões de vendas e acessos no e-commerce. Nessa palestra vou compartilhar o que fizemos para dessa data com tranquilidade e o que planejamos para que a desse ano também seja um sucesso. |
| PEP 20  | 15:50 - 16:35 | **Como a programação mudou a minha vida - de médica a programadora** | **Loyanne Repolho** | Como foi o processo de transição de carreira de 4 anos como clinico geral para programadora em menos de 1 ano e o que me inspirou a desenvolver uma skill para Alexa direcionada à pacientes em suspeita ou com diagnóstico de Hipertensão Arterial usando Python e Lambda. |
| PEP 404 | 15:50 - 16:35 | **Dados categóricos em árvore de decisão utilizando libs Python** | **Ana Paula da Silva Mendes** | Alguns algoritmos de árvore de decisão com Python são restritos a dados numéricos. A palestra irá abordar o uso de dados categóricos em árvore de decisão utilizando libs Python abordando algumas dificuldades em problemas restritos ao uso de dados categóricos. |
| PEP 8 | 15:50 - 16:35 | **Reconhecimento Facial em 5 passos** | **Giovana Oliveira de Lucca** | A palestra tem como objetivo apresentar os métodos da biblioteca Face Recognition da linguagem Python em apenas 5 passos e demonstrar, por meio de exemplos, a simplicidade da utilização destes métodos para implementar as técnicas de Reconhecimento Facial. |
| PEP 20 | 16:40 - 17:25 | **Impulsionando sua carreira em tecnologia** | **Leticia Portella** | A palestra aborda aprendizagens que tive e o como isso afeta o desenvolvimento dos programas com os quais trabalho. Abordarei não só as questões técnicas, mas também a parte mais humana desse processo. |
| PEP 20 | 18:20 - 19:05 | **PyBR 2019: o impacto das comunidades na transição de carreira de uma mulher preta e a criação de novas perspectivas** | **Allana Dabia Cardoso Teixeira de Paula** | O protagonismo profissional de grupos minoritários foi, historicamente, algo utópico. A área de TI tem se tornado mais acessível à esses grupos a partir da articulação destas comunidades, a estas ações dá-se o nome de devolutivas: doar após receber. Contarei um pouco sobre isto.|
| PEP 20 | 19:10 - 19:55 | **Empatia, ética, algoritmos e o futuro** | **Carla Vieira** |  Você é responsável pelo código que escreve? É fácil esquecer que o código que escrevemos afeta vidas reais. Precisamos estar cientes de quanto poder nos foi dado e assumir a responsabilidade pelo que construímos. |
| PEP 8 | 19:10 - 19:55 | **WebScraping, Python e Ordem da Câmara dos Vereadores** | **Gabriela Cavalcante da Silva** | Vamos conversar sobre algumas ferramentas e recursos python que temos disponível para fazer projetos de raspagem de dados. Vou dividir um pouco da minha experiência analisando documentos da Câmara dos Vereadores de Natal usando Python e WebScraping.|
